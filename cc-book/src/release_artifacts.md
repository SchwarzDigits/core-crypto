...
native libraries for macOS on Apple silicon, for Windows on x86_64, and for Linux on x86_64 and arm64 with glibc 2.28 or
newer (RHEL 8, SLES 15 SP3, Debian 11, Ubuntu 20.04 and later).
