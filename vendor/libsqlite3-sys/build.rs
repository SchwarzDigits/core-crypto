...
#[cfg(all(feature = "bundled-sqlite3mc", any(feature = "sqlcipher", feature = "bundled-sqlcipher")))]
compile_error!("feature \"bundled-sqlite3mc\" cannot be enabled together with feature \"sqlcipher\" or \"bundled-sqlcipher\"");
...
mod build_bundled {
    ...
    pub fn main(out_dir: &str, out_path: &Path) {
        ...
        if cfg!(feature = "bundled-sqlite3mc") {
            ...
            // ChaCha20-Poly1305, without which the value-level encryption of SQLite3 Multiple Ciphers
            // doesn't build. No crypto library is linked. Temporary files stay in memory, as in the
            // SQLCipher build.
