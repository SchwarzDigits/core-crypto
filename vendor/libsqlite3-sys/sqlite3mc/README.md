...
- The other schemes (AES-128-CBC, AES-256-CBC, RC4, Ascon, AEGIS) are left out. ChaCha20-Poly1305 stays in, unused,
  because the value-level encryption of SQLite3 Multiple Ciphers doesn't build without it. No crypto library is linked:
  SQLite3 Multiple Ciphers brings its own AES, SHA-512 and random number generator.
...
1. Replace the four files above and update this README.
